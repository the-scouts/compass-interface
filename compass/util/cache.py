...
from compass.core.util.cache_hooks import _Opt
from compass.core.util.cache_hooks import setup_cache as setup_cache_hooks
...
def setup_cache(backend: Literal["memory", "disk"], expiry: int = 0):
    ...
    """
    setup_cache_hooks(backend, set_val, get_val, clear, expiry)
